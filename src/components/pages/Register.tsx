...
import { Mail, Lock, User, Building, Eye, EyeOff, Check, X, ArrowLeft } from 'lucide-react';
...
export function Register({ onBackToLanding }: RegisterProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl bg-slate-50 border transition-all focus:outline-none focus:ring-2 ${
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={!acceptTerms || !passwordMatch}
              className="w-full px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-orange-500 text-white shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Create Account
            </motion.button>
          </form>
